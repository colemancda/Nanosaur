...
private func loadDemoModel() -> [RenderableMesh] {
    let candidates = [
        "Data/Skeletons/Rex.3dmf",
        "Data/Models/Title.3dmf",
        "Data/Models/Global_Models.3dmf",
    ]
    ...
    for path in candidates where fm.fileExists(atPath: path) {
        ...
        return file.meshes.map { RenderableMesh($0) }
    }
    return []
}
...
do {
    ...
    window.renderables = loadDemoModel()
